...
#################################################
#clear          : Denne funksjonen vil klare skjermen med 30 blanke linjer
#Etter-Bruk     : print ut 30 blanke linjer
#################################################
def clear():
        os.system("cls")
...
#pre-condition  : input må være en string 1, 2 eller 3.
